...
public interface PolicyService {
    ...
    PolicyDTO findPolicyDetail(int policyId) throws SQLException;
    ...
    // 정책 삭제 (관리자용)
    void deletePolicy(int policyId) throws SQLException;

    // 좋아요 증가
    void increaseLikes(int policyId) throws SQLException;
}
