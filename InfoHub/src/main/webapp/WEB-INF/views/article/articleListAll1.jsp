...
<!-- 네비게이션 -->
    ...
    <nav class="news-nav">
      ...
      <a href="articleListAll1" class="active">부동산</a>
...
<script>
	...
	function setPerPageNumSelect() {
		...
		$perPageSel.on('change', function() {
			window.location.href = "articleListAll1?page=" + thisPage
	...
	function setSearchTypeSelect() {
		...
		$('#searchBtn').on(
				...
				function() {
					...
					var url = "articleListAll1?page=1" 
							+ "&perPageNum="
