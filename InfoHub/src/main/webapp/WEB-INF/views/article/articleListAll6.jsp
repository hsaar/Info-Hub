		...
		<ul class="search_info">
			...
			name="perPageNum" value=${pageMaker.cri.perPageNum }></input>
				...
				<div class="text-center">
					<ul class="pageInfo">
						<li id="page-prev"><a
							href="articleListAll6${pageMaker.makeSearch(pageMaker.startPage-1)}">&laquo;</a></li>

						<c:forEach begin="${pageMaker.startPage }"
							end="${pageMaker.endPage }" var="idx">
							<li
								<c:out value="${pageMaker.cri.page == idx?'class =active':'' }"/>>
								<a href="articleListAll6?page=${idx }">${idx }</a>
							</li>
						</c:forEach>

						<c:if test="${pageMaker.next && pageMaker.endPage > 0 }">
							<li><a
								href="articleListAll6${pageMaker.makeSearch(pageMaker.endPage +1) }">&raquo;</a></li>
						</c:if>

						<!-- 처음 목록 버튼 추가 -->
						<li id = "page-fitst">
						<a href="articleListAll6" class="btn btn-warning">처음목록</a></li>
					</ul>
				</div>
