		...
		<main class="news-main">
			...
			<div class='box-body'>
				...
				<div class="text-center">
					<ul class="pageInfo">
						<li id="page-prev"><a
							href="slistPage${pageMaker.makeSearch(pageMaker.startPage-1)}">&laquo;</a></li>

						<c:forEach begin="${pageMaker.startPage }"
							end="${pageMaker.endPage }" var="idx">
							<li
								<c:out value="${pageMaker.cri.page == idx?'class =active':'' }"/>>
								<a href="slistPage?page=${idx }">${idx }</a>
							</li>
						</c:forEach>

						<c:if test="${pageMaker.next && pageMaker.endPage > 0 }">
							<li><a
								href="slistPage${pageMaker.makeSearch(pageMaker.endPage +1) }">&raquo;</a></li>
						</c:if>
						...
						<li id="page-next"><a
							href="slistPage${pageMaker.makeSearch(pageMaker.startPage-1)}">&raquo;</a></li>
						<!-- 처음 목록 버튼 추가 -->
						<li id = "page-fitst">
