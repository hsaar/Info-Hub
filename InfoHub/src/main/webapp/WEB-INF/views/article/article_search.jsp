...
<body >
	...
	<div class="news-header">
		<nav class="news-nav">
			<a href="#" class="active">종합</a> <a href="articleListAll1">부동산</a> <a
				href="articleListAll2">주식</a> <a href="articleListAll3">적금</a> <a
				href="articleListAll4">복지</a> <a href="articleListAll5">창업</a> <a
				href="#">기타</a>
		</nav>
	</div>
		...
		<main class="news-main">
			...
			<div class='box-body'>
				...
				<table  border="1" cellpadding="20" cellspacing="0">
					...
					<c:forEach items="${slistPage}" var="slistPage">
						<tr>
							<td>${slistPage.articleId}</td>
							<td><a href="articleContent?title=${slistPage.title}">${slistPage.title}</a></td>
							<td>${slistPage.name}</td>
							<td>${slistPage.published}</td>
							<td>${slistPage.source}</td>
							<td>${slistPage.views}</td>
						</tr>
					</c:forEach>
				</table>
				...
				<div class="text-center">
					<ul class="pageInfo">
						<li id="page-prev"><a
							href="article_search${pageMaker.makeSearch(pageMaker.startPage-1)}">&laquo;</a></li>

						<c:forEach begin="${pageMaker.startPage }"
							end="${pageMaker.endPage }" var="idx">
							<li
								<c:out value="${pageMaker.cri.page == idx?'class =active':'' }"/>>
								<a href="article_search?page=${idx }">${idx }</a>
							</li>
						</c:forEach>

						<c:if test="${pageMaker.next && pageMaker.endPage > 0 }">
							<li><a
								href="article_search${pageMaker.makeSearch(pageMaker.endPage +1) }">&raquo;</a></li>
						</c:if>
						...
						<li id="page-next"><a
							href="article_search${pageMaker.makeSearch(pageMaker.startPage-1)}">&raquo;</a></li>
						<!-- 처음 목록 버튼 추가 -->
						<li id = "page-fitst">
						<a href="article_search" class="btn btn-warning">처음목록</a></li>
					</ul>
				</div>
			</table>
		</main>
