...
<body>
	...
	<div class="news-header">
		<nav class="news-nav">
			<a href="#" class="active">종합</a> <a href="#">부동산</a> <a href="#">주식</a>
			<a href="#">적금</a> <a href="#">복지</a> <a href="#">창업</a> <a href="#">기타</a>
		</nav>
	</div>
	...
	<!-- 메인 컨테이너 -->
	<div class="news-00000container">
		<!-- 메인 콘텐츠 -->
		<main class="news-main">
			<h1 class="news-title">최신기사 조회</h1>

			<article class="news-item">
				<div class="news-content">
					<h3>
						<a href="articleContent?article_id=${article.article_id}"
				...
				<div class="news-media">${article.name}|${article.source }<br>
					${article.published}<br> ${article.hearts }(좋아요 수)
				</div>
			</article>
			...
			<article class="news-item">
				<div class="news-content">
					<h3>
						<a href="#">"AI와 함께 일하는 시대… 기자의 격차 더 벌어진다"</a>
					</h3>
					<div class="news-meta">09-17 09:52</div>
					<p class="news-summary">한국인터넷신문협회(회장 김기정=그린포스트코리아 대표)는 16일
						한국프레스센터 10층 협회 회의실에서 최영순 구글 뉴스랩 팀장님을 초청해 'AI와 함께 일하는 법'을 주제...</p>
				</div>
			...
			<nav class="pagination">
				<a href="#" class="page-btn">이전</a> <a href="#"
					class="page-btn active">1</a> <a href="#" class="page-btn">2</a> <a
					href="#" class="page-btn">3</a> <a href="#" class="page-btn">다음</a>
			</nav>
		</main>
