...
<!-- 네비게이션 -->
    ...
    <nav class="news-nav">
      ...
      <a href="articleListAll5" class="active">창업</a>
      <a href="#">기타</a>
    </nav>
	</div>
   ...
   <!-- 페이지네이션 -->
      <div class="text-cente">
				...
				<div class="text-center">
					<ul class="pageInfo">
						<li id="page-prev"><a
							href="articleListAll5${pageMaker.makeSearch(pageMaker.startPage-1)}" style="text-decoration: none; color: inherit;">&laquo;</a></li>

						<c:forEach begin="${pageMaker.startPage }"
							end="${pageMaker.endPage }" var="idx">
							<li
								<c:out value="${pageMaker.cri.page == idx?'class =active':'' }"/>>
								<a href="articleListAll5?page=${idx }" style="text-decoration: none; color: inherit;">${idx }</a>
							</li>
						</c:forEach>

						<c:if test="${pageMaker.next && pageMaker.endPage > 0 }">
							<li><a
								href="articleListAll5${pageMaker.makeSearch(pageMaker.endPage +1) }">&raquo;</a></li>
						</c:if>

						<c:if test="${pageMaker.prev }">
							<li><a
								href="articleListAll5${pageMaker.makeSearch(pageMaker.startPage -1) }">&laquo;</a></li>
						</c:if>

						<li id="page-next"><a
							href="articleListAll5${pageMaker.makeSearch(pageMaker.startPage-1)}" style="text-decoration: none; color: inherit;">&raquo;</a></li>
						<!-- 처음 목록 버튼 추가 -->
						<li id = "page-fitst">
						<a href="articleListAll5" class="btn btn-warning" style="text-decoration: none; color: inherit;">처음목록</a></li>
					</ul>
				</div>
...
<script>
	...
	function setPerPageNumSelect() {
		...
		$perPageSel.on('change', function() {
			window.location.href = "articleListAll5?page=" + thisPage
	...
	function setSearchTypeSelect() {
		...
		$('#searchBtn').on(
				...
				function() {
					...
					var url = "articleListAll5?page=1" 
							+ "&perPageNum="
