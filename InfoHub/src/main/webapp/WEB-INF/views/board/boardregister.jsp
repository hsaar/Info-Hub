...
<div class="breadcrumb-nav">
    <div class="container">
        ...
        <a href="${pageContext.request.contextPath}/listcategory?category=${categoryId}&sort=${sort}">게시판</a>
        <svg viewBox="0 0 24 24" width="16" height="16" fill="#9ca3af">
            <path d="M10 6L8.59 7.41 13.17 12l-4.58 4.59L10 18l6-6z"/>
        </svg>
        <span>새 글쓰기</span>
...
document.querySelector('.write-form-card').addEventListener('input', function() {
    formChanged = true;
});
...
// 폼 제출 시에는 이탈 방지 해제
document.querySelector('.write-form-card').addEventListener('submit', function() {
    formChanged = false;
});
</script>
